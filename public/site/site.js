(() => {
  ...
  const DISCORD_EMERGENCIAS = 'https://discord.gg/Hxn35UJJmX';
  ...
  function hero() {
    return `<section class="container hero-section"><div class="hero-carousel" id="hero-carousel" aria-roledescription="carrusel">
      <div class="hero-track" id="hero-track">
        ...
        <article class="hero-slide">${assetImg(GALLERY[1],'','hero-slide-img')}<div class="hero-overlay"><div class="hero-text"><span class="eyebrow">Los cuerpos</span><h1 class="hero-title">Policía Nacional, Guardia Civil,<br><span class="accent">Policía Local, SESCV y Bomberos.</span></h1><p class="hero-sub">Patrulla, sube de rango y vive intervenciones coordinadas entre todos los servicios.</p><div class="hero-cta"><a href="/servidor" class="btn btn-primary btn-lg">Descubrir el servidor</a></div></div></div></article>
  ...
  function home() {
    return `<main>${hero()}
      <section class="section"><div class="container"><div class="section-head"><span class="eyebrow">Por qué unirte</span><h2>Una experiencia cuidada al detalle</h2><p class="section-lead">Todo está calibrado para un roleplay inmersivo, fluido y serio.</p></div><div class="grid grid-3" data-reveal>
        ...
        <article class="card feature-card"><span class="feature-icon-wrap">${featureIcon('emergency')}</span><h3>Servicios de emergencia completos</h3><p>Policía Nacional, Guardia Civil, Policía Local, SESCV y Bomberos con jerarquía y equipamiento propios.</p></article>
      ...
      <section class="section"><div class="container"><div class="cta-banner card" data-reveal><div><h2>¿Listo para entrar en rol?</h2><p>Crea tu personaje, únete a una patrulla y vive el rol policial como nunca.</p></div><div class="cta-banner-actions"><a href="${DISCORD}" target="_blank" rel="noopener" class="btn btn-primary btn-lg">Unirse ahora</a><a href="/servidor" class="btn btn-ghost btn-lg">Saber más</a></div></div></div></section>
    </main>`;
  }
  ...
  function servidor() {
    return `<main>${pageHero('El servidor','Bienvenido a Valencia PD','FivePD con identidad valenciana, servicios de emergencia y una forma de jugar centrada en el rol.')}
      ...
      <section class="section"><div class="container"><div class="section-head"><span class="eyebrow">Los AOP</span><h2>Tres escenarios, tres plantillas de servicios</h2><p class="section-lead">Los cuerpos disponibles cambian según el AOP establecido.</p></div><div class="grid grid-3" data-reveal>
        <article class="card feature-card"><h3>AOP Valencia Centro (Ciudad)</h3><p>Policía Nacional · Policía Local de Valencia · SESCV · Cuerpo de Bomberos del Ayuntamiento de Valencia.</p></article>
        <article class="card feature-card"><h3>AOP Torrent (Paleto Bay)</h3><p>Guardia Civil · Policía Local de Torrent · SESCV · Cuerpo de Bomberos de la Comunidad Valenciana.</p></article>
        <article class="card feature-card"><h3>AOP Burjassot (Sandy Shores y Grapeseed)</h3><p>Guardia Civil · Policía Local de Burjassot · SESCV · Cuerpo de Bomberos de la Comunidad Valenciana.</p></article>
      </div></div></section>
  ...
  function servicios() {
    const services = [
      ['Discord de emergencias','Espacio de coordinación para los servicios de emergencias y sus trámites internos.',DISCORD_EMERGENCIAS,'Entrar al Discord','discord'],
      ['Discord Valencia PD','Comunidad principal, soporte, avisos y organización del servidor.',DISCORD,'Entrar al Discord','discord']
    ];
    return `<main>${pageHero('Servicios','Servicios oficiales','Accesos directos a los dos Discord que usamos en la comunidad.')}
  ...
  function privacidad() { return `<main>${pageHero('Legal','Política de privacidad','Información clara sobre los datos que pueden tratarse al utilizar ValenciaPD.')}<section class="section"><div class="container legal-layout"><aside class="toc card"><h4>Índice</h4><nav><a href="#responsable">1. Responsable</a><a href="#datos">2. Datos que tratamos</a><a href="#finalidad">3. Finalidades</a><a href="#legitimacion">4. Base jurídica</a><a href="#proveedores">5. Proveedores y terceros</a><a href="#conservacion">6. Conservación</a><a href="#derechos">7. Derechos</a><a href="#cookies">8. Cookies y sesión</a><a href="#seguridad">9. Seguridad</a><a href="#cambios">10. Cambios</a></nav></aside><div class="prose-block legal-page"><article id="responsable" class="rule-section"><h2>1. Responsable del tratamiento</h2><p class="prose">ValenciaPD es un proyecto comunitario de roleplay sin ánimo de lucro. La comunidad determina los medios y finalidades necesarios para prestar sus servicios web y gestionar las funciones que el usuario solicita.</p><p class="prose">Para consultas relacionadas con privacidad o para ejercer tus derechos, puedes contactar a través del Discord oficial de ValenciaPD.</p></article><article id="datos" class="rule-section"><h2>2. Datos que tratamos</h2><p class="prose">Según cómo utilices la web, pueden tratarse:</p><ul><li><strong>Datos de Discord:</strong> identificador de usuario, nombre de usuario, nombre mostrado y avatar cuando utilizas la conexión mediante Discord.</li><li><strong>Datos técnicos:</strong> dirección IP, fecha y hora de acceso, navegador, dispositivo y registros técnicos necesarios para seguridad y funcionamiento.</li><li><strong>Información que facilitas:</strong> datos que envíes voluntariamente mediante formularios, tickets o canales de soporte.</li></ul><p class="prose">Solo se solicitarán los datos que resulten adecuados y pertinentes para la función correspondiente.</p></article><article id="finalidad" class="rule-section"><h2>3. Finalidades</h2><ul><li>Autenticar y mantener la sesión cuando conectas tu cuenta de Discord.</li><li>Gestionar verificaciones, soporte y trámites de la comunidad.</li><li>Prevenir usos abusivos, accesos no autorizados y problemas de seguridad.</li><li>Mantener, proteger y mejorar el funcionamiento de la plataforma.</li></ul></article><article id="legitimacion" class="rule-section"><h2>4. Base jurídica</h2><p class="prose">La base jurídica depende de la finalidad. La conexión voluntaria de Discord se realiza a petición del usuario y, cuando corresponda, con su consentimiento. Los tratamientos estrictamente necesarios para seguridad, prevención del abuso y funcionamiento técnico pueden basarse en el interés legítimo, dentro de los límites previstos por la normativa aplicable.</p></article><article id="proveedores" class="rule-section"><h2>5. Proveedores y terceros</h2><p class="prose">Para prestar determinados servicios se utilizan proveedores técnicos, entre ellos Discord para autenticación y comunidad, Vercel para alojamiento e infraestructura y FiveM/Cfx.re para la conexión o información del servidor. Estos servicios tienen sus propias condiciones y políticas de privacidad.</p><p class="prose">Cuando un proveedor pueda tratar datos fuera del Espacio Económico Europeo, se aplicarán las garantías y mecanismos de transferencia que correspondan.</p></article><article id="conservacion" class="rule-section"><h2>6. Conservación</h2><p class="prose">Los datos se conservarán durante el tiempo necesario para la finalidad para la que fueron obtenidos. La sesión de Discord se mantiene durante el periodo previsto por el sistema de autenticación. Los registros técnicos se conservarán durante el tiempo razonablemente necesario para seguridad, mantenimiento y atención de incidencias, salvo obligación legal de conservación durante un periodo superior.</p></article><article id="derechos" class="rule-section"><h2>7. Tus derechos</h2><p class="prose">Puedes solicitar, cuando proceda, el acceso, rectificación, supresión, limitación u oposición al tratamiento, así como la portabilidad de los datos en los supuestos previstos legalmente. Cuando el tratamiento se base en el consentimiento, puedes retirarlo en cualquier momento.</p><p class="prose">Puedes ejercer estos derechos a través de los canales oficiales de ValenciaPD. También puedes presentar una reclamación ante la Agencia Española de Protección de Datos si consideras que tus derechos no han sido respetados.</p></article><article id="cookies" class="rule-section"><h2>8. Cookies y sesión</h2><p class="prose">La web utiliza mecanismos técnicos necesarios para mantener determinadas funciones. La conexión de Discord utiliza una cookie de sesión técnica que permite mantener la sesión autenticada. No se utiliza esta cookie para publicidad personalizada.</p></article><article id="seguridad" class="rule-section"><h2>9. Seguridad</h2><p class="prose">Se aplican medidas técnicas razonables para proteger la información frente a accesos no autorizados, pérdida o alteración. Ningún sistema conectado a Internet puede garantizar una seguridad absoluta.</p></article><article id="cambios" class="rule-section"><h2>10. Cambios en esta política</h2><p class="prose">Esta política puede actualizarse cuando cambien los servicios, la infraestructura o las obligaciones aplicables. La versión publicada en esta página será la vigente desde su publicación.</p><p class="legal-updated">Última actualización: 11 de septiembre de 2026.</p></article></div></div></section></main>`; }

  function terminos() { return `<main>${pageHero('Legal','Términos y condiciones','Condiciones de uso de la web y de los servicios de ValenciaPD.')}<section class="section"><div class="container legal-layout"><aside class="toc card"><h4>Índice</h4><nav><a href="#objeto">1. Objeto</a><a href="#aceptacion">2. Aceptación</a><a href="#acceso">3. Acceso y cuenta</a><a href="#discord">4. Discord</a><a href="#fivem">5. FiveM y juego</a><a href="#conducta">6. Conducta</a><a href="#moderacion">7. Moderación</a><a href="#disponibilidad">8. Disponibilidad</a><a href="#propiedad">9. Propiedad y marcas</a><a href="#responsabilidad">10. Responsabilidad</a><a href="#cambios">11. Cambios</a></nav></aside><div class="prose-block legal-page"><article id="objeto" class="rule-section"><h2>1. Objeto</h2><p class="prose">Estos términos regulan el acceso y uso de la web de ValenciaPD y de las funciones que la comunidad pone a disposición de sus usuarios.</p></article><article id="aceptacion" class="rule-section"><h2>2. Aceptación</h2><p class="prose">Al acceder a la web o utilizar alguno de sus servicios, aceptas estos términos y las normas específicas de la comunidad. Si no estás de acuerdo, debes dejar de utilizar el servicio.</p></article><article id="acceso" class="rule-section"><h2>3. Acceso y cuenta</h2><p class="prose">Cuando una función requiere identificación mediante Discord, debes utilizar una cuenta que te pertenezca. No compartas credenciales ni intentes utilizar sistemas destinados a eludir controles o restricciones.</p></article><article id="discord" class="rule-section"><h2>4. Discord</h2><p class="prose">Parte de la comunidad funciona a través de Discord. Además de estas condiciones y de las normas de ValenciaPD, el uso de Discord queda sujeto a sus propios términos y reglas. El acceso a los espacios de la comunidad puede limitarse por incumplimiento.</p></article><article id="fivem" class="rule-section"><h2>5. FiveM y juego</h2><p class="prose">El servidor de juego se presta mediante FiveM/Cfx.re y depende de la disponibilidad de sus servicios y de los requisitos técnicos necesarios para conectarse. El acceso puede cambiar por mantenimiento, actualizaciones o decisiones de la plataforma.</p></article><article id="conducta" class="rule-section"><h2>6. Conducta y uso correcto</h2><ul><li>Está prohibido intentar acceder sin autorización a sistemas o modificar la infraestructura.</li><li>No se permite introducir código malicioso, automatizaciones abusivas o herramientas para causar daños o interrupciones.</li><li>No está permitido suplantar a usuarios, miembros del equipo o terceros.</li><li>Debes respetar la normativa de roleplay, las reglas de Discord y las indicaciones del equipo de moderación.</li></ul></article><article id="moderacion" class="rule-section"><h2>7. Moderación</h2><p class="prose">El equipo de ValenciaPD puede limitar o retirar el acceso a funciones o espacios de la comunidad cuando resulte necesario para aplicar la normativa, proteger a otros usuarios o responder ante abusos. Las medidas se adoptarán atendiendo a las circunstancias y a las reglas internas vigentes.</p></article><article id="disponibilidad" class="rule-section"><h2>8. Disponibilidad</h2><p class="prose">La web y los servicios pueden sufrir mantenimientos, errores, interrupciones o cambios. Algunos componentes dependen de terceros y ValenciaPD no puede garantizar su funcionamiento continuo.</p></article><article id="propiedad" class="rule-section"><h2>9. Propiedad y marcas</h2><p class="prose">Los recursos creados específicamente para ValenciaPD pertenecen a sus respectivos titulares. Discord, FiveM, Cfx.re, Rockstar Games y Take-Two Interactive son marcas y servicios de sus respectivos propietarios. ValenciaPD no está afiliado ni patrocinado por Rockstar Games o Take-Two Interactive.</p></article><article id="responsabilidad" class="rule-section"><h2>10. Responsabilidad</h2><p class="prose">ValenciaPD es un proyecto comunitario sin ánimo de lucro. Cada usuario es responsable del uso que haga de la web y de los servicios. No se garantiza disponibilidad permanente ni ausencia de incidencias en servicios propios o de terceros.</p></article><article id="cambios" class="rule-section"><h2>11. Cambios</h2><p class="prose">Estos términos pueden modificarse cuando cambien los servicios o sea necesario actualizar sus reglas. La versión publicada en esta página será la aplicable desde su publicación.</p><p class="legal-updated">Última actualización: 11 de septiembre de 2026.</p></article></div></div></section></main>`; }
  ...
  function estado() { return `<main>${pageHero('Estado','Estado en desarrollo','El servidor se encuentra actualmente en desarrollo.')}</main>`; }
